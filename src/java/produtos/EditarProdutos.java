...
public class EditarProdutos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet EditarProdutos</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet EditarProdutos at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {
            out.close();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String codigodebarra = request.getParameter("codigo_de_barras");

        ProdutosDAO.atualizar(codigo, nome, quantidade, preco, categoria, mercado, tamanho, marca, formadecalcularvenda, codigodebarra);
