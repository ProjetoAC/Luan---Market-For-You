<%-- 
    Document   : cadastrar_mercado
    Created on : 14/10/2016, 15:16:39
    Author     : Senai
--%>

<%@page import="mercados.Mercado"%>
<%@page import="mercados.MercadoDAO"%>
<%@page import="mercados.*"%>
<%@page contentType="text/html" pageEncoding="UTF-8"%>
<!DOCTYPE html>
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>Cadastro do Mercado</title>
    </head>
    ...
    <div class="row">
        <div class="col-sm-9">
            ...
            <div class="row">
                ...
                <form class="form-horizontal" action="SalvarMercado" method="post">
